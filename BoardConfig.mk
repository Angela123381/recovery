...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 56419596 # This is the maximum known partition size, but it can be higher, so we just omit it
...
TARGET_KERNEL_CONFIG := jd2018_defconfig
